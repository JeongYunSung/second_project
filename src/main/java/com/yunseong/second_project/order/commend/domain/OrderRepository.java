...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("select new com.yunseong.second_project.order.query.OrderResponse(o.id, o.totalPrice, o.orderStatus, p.paymentStatus) from Order o left join o.payment p where o.createdMemberId = :id")
    Page<OrderResponse> findByPage(Pageable pageable, Long id);
